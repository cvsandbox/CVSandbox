...
#pragma once
#ifndef CVS_GAMEPAD_PLUGIN_HPP
#define CVS_GAMEPAD_PLUGIN_HPP
...
class GamepadPlugin : public IDevicePlugin
{
public:
    GamepadPlugin( );
...
private:
    ...
    ::Private::GamepadPluginData*       mData;
};

#endif // CVS_GAMEPAD_PLUGIN_HPP
