...
#pragma once
#ifndef CVS_PNG_EXPORTER_PLUGIN_HPP
#define CVS_PNG_EXPORTER_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class PngExporterPlugin : public IImageExportingPlugin
{
public:
    PngExporterPlugin( );
...
#endif // CVS_PNG_EXPORTER_PLUGIN_HPP
