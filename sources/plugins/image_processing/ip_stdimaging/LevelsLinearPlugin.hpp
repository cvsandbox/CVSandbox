...
#pragma once
#ifndef CVS_LEVELS_LINEAR_PLUGIN_HPP
#define CVS_LEVELS_LINEAR_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class LevelsLinearPlugin : public IImageProcessingFilterPlugin
{
public:
    LevelsLinearPlugin( );
...
#endif // CVS_LEVELS_LINEAR_PLUGIN_HPP
