...
#pragma once
#ifndef CVS_SHIFT_IMAGE_PLUGIN_HPP
#define CVS_SHIFT_IMAGE_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class ShiftImagePlugin : public IImageProcessingFilterPlugin
{
public:
    ShiftImagePlugin( );
...
#endif // CVS_SHIFT_IMAGE_PLUGIN_HPP
