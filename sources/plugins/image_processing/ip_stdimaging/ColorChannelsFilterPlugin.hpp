...
#pragma once
#ifndef CVS_COLOR_CHANNELS_FILTER_PLUGIN_HPP
#define CVS_COLOR_CHANNELS_FILTER_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class ColorChannelsFilterPlugin : public IImageProcessingFilterPlugin
{
public:
...
private:
    ...
    uint8_t greenMax;
    uint8_t greenFill;
    bool    greenFillOutside;

    uint8_t blueMin;
    uint8_t blueMax;
    uint8_t blueFill;
    bool    blueFillOutside;
...
#endif // CVS_COLOR_CHANNELS_FILTER_PLUGIN_HPP
