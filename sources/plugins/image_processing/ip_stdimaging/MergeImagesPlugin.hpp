...
#pragma once
#ifndef CVS_MERGE_IMAGES_PLUGIN_HPP
#define CVS_MERGE_IMAGES_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class MergeImagesPlugin : public IImageProcessingFilterPlugin2
{
public:
...
#endif // CVS_MERGE_IMAGES_PLUGIN_HPP
