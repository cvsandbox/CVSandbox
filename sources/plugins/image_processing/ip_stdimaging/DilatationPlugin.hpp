...
#pragma once
#ifndef CVS_DILATATION_PLUGIN_HPP
#define CVS_DILATATION_PLUGIN_HPP

#include <ximaging.h>
#include <iplugintypescpp.hpp>

class DilatationPlugin : public IImageProcessingFilterPlugin
{
private:
    ~DilatationPlugin( );
...
private:
    ...
    uint8_t                           radius;
    XStructuringElementType           type;
    int8_t*                           structuringElement;
};

#endif // CVS_DILATATION_PLUGIN_HPP
