...
#pragma once
#ifndef CVS_CONTRAST_CORRECTION_PLUGIN_HPP
#define CVS_CONTRAST_CORRECTION_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class ContrastCorrectionPlugin : public IImageProcessingFilterPlugin
{
public:
...
#endif // CVS_CONTRAST_CORRECTION_PLUGIN_HPP
