...
#pragma once
#ifndef CVS_ERODE_EDGES_PLUGIN_HPP
#define CVS_ERODE_EDGES_PLUGIN_HPP

#include <ximaging.h>
#include <iplugintypescpp.hpp>

class ErodeEdgesPlugin : public IImageProcessingFilterPlugin
{
public:
    ErodeEdgesPlugin( );
...
private:
    ...
    uint8_t                           edgeType; // 0 - horizontal, 1 - vertical
};

#endif // CVS_ERODE_EDGES_PLUGIN_HPP
