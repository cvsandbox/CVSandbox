...
#pragma once
#ifndef CVS_OBJECTS_THINNING_PLUGIN_HPP
#define CVS_OBJECTS_THINNING_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class ObjectsThinningPlugin : public IImageProcessingFilterPlugin
{
public:
...
private:
    ...
    uint16_t thinningAmount;
    ximage*  tempDistanceMap;
};

#endif // CVS_OBJECTS_THINNING_PLUGIN_HPP
