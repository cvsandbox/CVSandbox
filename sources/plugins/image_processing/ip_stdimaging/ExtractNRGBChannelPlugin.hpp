...
#pragma once
#ifndef CVS_EXTRACT_NRGB_CHANNEL_PLUGIN_HPP
#define CVS_EXTRACT_NRGB_CHANNEL_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class ExtractNRGBChannelPlugin : public IImageProcessingFilterPlugin
{
public:
...
#endif // CVS_EXTRACT_NRGB_CHANNEL_PLUGIN_HPP
