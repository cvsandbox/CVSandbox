...
#pragma once
#ifndef CVS_RUN_LENGTH_SMOOTHING_PLUGIN_HPP
#define CVS_RUN_LENGTH_SMOOTHING_PLUGIN_HPP

#include <ximaging.h>
#include <iplugintypescpp.hpp>

class RunLengthSmoothingPlugin : public IImageProcessingFilterPlugin
{
public:
...
private:
    ...
    uint8_t                           gapType; // 0 - horizontal, 1 - vertical
    uint16_t                          maxGapToFill;
};

#endif // CVS_RUN_LENGTH_SMOOTHING_PLUGIN_HPP
