...
#pragma once
#ifndef CVS_GAUSSIAN_SHARPEN_PLUGIN_HPP
#define CVS_GAUSSIAN_SHARPEN_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class GaussianSharpenPlugin : public IImageProcessingFilterPlugin
{
public:
...
#endif // CVS_GAUSSIAN_SHARPEN_PLUGIN_HPP
