...
#include <image_dilatation_16x16.h>
...
// ID of the plug-in
static xguid PluginID = { 0xAF000003, 0x00000000, 0x00000001, 0x0000001C };

// Radius property
static PropertyDescriptor radiusProperty =
{ XVT_U1, "Radius", "radius", "Radius of dilatation structuring element.", PropertyFlag_None };
...
const PropertyDescriptor** DilatationPlugin::propertiesDescription = (const PropertyDescriptor**) pluginProperties;
...
(
    ...
    "Dilatation",
    "Dilatation",
    "Applies dilatation morphology operator using a structuring element of the specified size and shape.",
    ...
    "This version of the dilation operator is designed to process color or grayscale images using a structuring "
    ...
    "for MAX operator. Below are the possible shapes for 7x7 structuring element ('*' corresponds to neighbour "
    "pixels to use):<br><br>"
    ...
    "See also: <a href='{AF000003-00000000-00000001-0000001B}'>Erosion operator</a>"
    ,
    &image_dilatation_16x16,
    0,
    DilatationPlugin,
