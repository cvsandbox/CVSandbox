...
#pragma once
#ifndef CVS_ADD_IMAGES_PLUGIN_HPP
#define CVS_ADD_IMAGES_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class AddImagesPlugin : public IImageProcessingFilterPlugin2
{
public:
    AddImagesPlugin( );
...
#endif // CVS_ADD_IMAGES_PLUGIN_HPP
