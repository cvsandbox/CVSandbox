...
#pragma once
#ifndef CVS_DISTANCE_TRANSFORMATION_PLUGIN_HPP
#define CVS_DISTANCE_TRANSFORMATION_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class DistanceTransformationPlugin : public IImageProcessingFilterPlugin
{
public:
...
#endif // CVS_DISTANCE_TRANSFORMATION_PLUGIN_HPP
