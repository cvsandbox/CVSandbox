...
#pragma once
#ifndef CVS_OTSU_THRESHOLD_PLUGIN_HPP
#define CVS_OTSU_THRESHOLD_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class OtsuThresholdPlugin : public IImageProcessingFilterPlugin
{
public:
    OtsuThresholdPlugin( );
...
#endif // CVS_OTSU_THRESHOLD_PLUGIN_HPP
