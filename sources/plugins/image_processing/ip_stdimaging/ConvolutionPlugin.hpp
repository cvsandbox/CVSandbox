...
#pragma once
#ifndef CVS_CONVOLUTION_PLUGIN_HPP
#define CVS_CONVOLUTION_PLUGIN_HPP

#include <ximaging.h>
#include <iplugintypescpp.hpp>

class ConvolutionPlugin : public IImageProcessingFilterPlugin
{
private:
    ~ConvolutionPlugin( );
...
private:
    ...
    float                             divisor;
    float                             offset;
    XConvolutionBorderHandlingMode    borderMode;
};

#endif // CVS_CONVOLUTION_PLUGIN_HPP
