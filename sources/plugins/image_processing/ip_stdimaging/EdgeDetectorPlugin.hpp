...
#pragma once
#ifndef CVS_EDGE_DETECTOR_PLUGIN_HPP
#define CVS_EDGE_DETECTOR_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class EdgeDetectorPlugin : public IImageProcessingFilterPlugin
{
public:
    EdgeDetectorPlugin( );
...
#endif // CVS_EDGE_DETECTOR_PLUGIN_HPP
