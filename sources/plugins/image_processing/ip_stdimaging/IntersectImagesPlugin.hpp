...
#pragma once
#ifndef CVS_INTERSECT_IMAGES_PLUGIN_HPP
#define CVS_INTERSECT_IMAGES_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class IntersectImagesPlugin : public IImageProcessingFilterPlugin2
{
public:
...
#endif // CVS_INTERSECT_IMAGES_PLUGIN_HPP
