...
#pragma once
#ifndef CVS_MASK_IMAGE_PLUGIN_HPP
#define CVS_MASK_IMAGE_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class MaskImagePlugin : public IImageProcessingFilterPlugin2
{
public:
    MaskImagePlugin( );
...
#endif // CVS_MASK_IMAGE_PLUGIN_HPP
