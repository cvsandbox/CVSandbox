...
#pragma once
#ifndef CVS_EXTRACT_RGB_CHANNEL_PLUGIN_HPP
#define CVS_EXTRACT_RGB_CHANNEL_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class ExtractRGBChannelPlugin : public IImageProcessingFilterPlugin
{
public:
...
#endif // CVS_EXTRACT_RGB_CHANNEL_PLUGIN_HPP
