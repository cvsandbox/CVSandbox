...
#pragma once
#ifndef CVS_ROTATE_IMAGE_PLUGIN_HPP
#define CVS_ROTATE_IMAGE_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class RotateImagePlugin : public IImageProcessingFilterPlugin
{
public:
    RotateImagePlugin( );
...
#endif // CVS_ROTATE_IMAGE_PLUGIN_HPP
