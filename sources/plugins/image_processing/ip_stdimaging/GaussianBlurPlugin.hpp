...
#pragma once
#ifndef CVS_GAUSSIAN_BLUR_PLUGIN_HPP
#define CVS_GAUSSIAN_BLUR_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class GaussianBlurPlugin : public IImageProcessingFilterPlugin
{
public:
    GaussianBlurPlugin( );
...
#endif // CVS_GAUSSIAN_BLUR_PLUGIN_HPP
