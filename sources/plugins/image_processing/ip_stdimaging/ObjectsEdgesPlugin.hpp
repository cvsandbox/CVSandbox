...
#pragma once
#ifndef CVS_OBJECTS_EDGES_PLUGIN_HPP
#define CVS_OBJECTS_EDGES_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class ObjectsEdgesPlugin : public IImageProcessingFilterPlugin
{
public:
    ObjectsEdgesPlugin( );
    ~ObjectsEdgesPlugin( );
...
private:
    ...
    uint16_t edgeThickness;
    ximage*  tempDistanceMap;
};

#endif // CVS_OBJECTS_EDGES_PLUGIN_HPP
