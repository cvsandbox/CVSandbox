...
#pragma once
#ifndef CVS_HISTOGRAM_EQUALIZATION_PLUGIN_HPP
#define CVS_HISTOGRAM_EQUALIZATION_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class HistogramEqualizationPlugin : public IImageProcessingFilterPlugin
{
public:
...
#endif // CVS_HISTOGRAM_EQUALIZATION_PLUGIN_HPP
