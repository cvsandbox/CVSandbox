...
#pragma once
#ifndef CVS_RESIZE_IMAGE_PLUGIN_HPP
#define CVS_RESIZE_IMAGE_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class ResizeImagePlugin : public IImageProcessingFilterPlugin
{
public:
    ResizeImagePlugin( );
...
#endif // CVS_RESIZE_IMAGE_PLUGIN_HPP
