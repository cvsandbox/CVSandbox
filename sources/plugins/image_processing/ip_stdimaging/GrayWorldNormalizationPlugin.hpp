...
#pragma once
#ifndef CVS_GRAY_WORLD_NORMALIZATION_PLUGIN_HPP
#define CVS_GRAY_WORLD_NORMALIZATION_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class GrayWorldNormalizationPlugin : public IImageProcessingFilterPlugin
{
public:
...
#endif // CVS_GRAY_WORLD_NORMALIZATION_PLUGIN_HPP
