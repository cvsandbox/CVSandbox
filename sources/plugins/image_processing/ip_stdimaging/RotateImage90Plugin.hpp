...
#pragma once
#ifndef CVS_ROTATE_IMAGE_90_PLUGIN_HPP
#define CVS_ROTATE_IMAGE_90_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class RotateImage90Plugin : public IImageProcessingFilterPlugin
{
public:
    RotateImage90Plugin( );
...
private:
    ...
    uint16_t rotationType;
};

#endif // CVS_ROTATE_IMAGE_90_PLUGIN_HPP
