...
#pragma once
#ifndef CVS_MEAN_SHIFT_PLUGIN_HPP
#define CVS_MEAN_SHIFT_PLUGIN_HPP

#include <ximaging.h>
#include <iplugintypescpp.hpp>

class MeanShiftPlugin : public IImageProcessingFilterPlugin
{
public:
    MeanShiftPlugin( );
...
#endif // CVS_MEAN_SHIFT_PLUGIN_HPP
