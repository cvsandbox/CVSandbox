...
#pragma once
#ifndef CVS_COLOR_FILTER_PLUGIN_HPP
#define CVS_COLOR_FILTER_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class ColorFilterPlugin : public IImageProcessingFilterPlugin
{
public:
    ColorFilterPlugin( );
...
#endif // CVS_COLOR_FILTER_PLUGIN_HPP
