...
#pragma once
#ifndef CVS_OBJECTS_THICKENING_PLUGIN_HPP
#define CVS_OBJECTS_THICKENING_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class ObjectsThickeningPlugin : public IImageProcessingFilterPlugin
{
public:
...
private:
    ...
    uint16_t growingAmount;
    ximage*  tempDistanceMap;
};

#endif // CVS_OBJECTS_THICKENING_PLUGIN_HPP
