...
#pragma once
#ifndef CVS_HEAT_GRADIENT_PLUGIN_HPP
#define CVS_HEAT_GRADIENT_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class HeatGradientPlugin : public IImageProcessingFilterPlugin
{
public:
    HeatGradientPlugin( );
...
#endif // CVS_HEAT_GRADIENT_PLUGIN_HPP
