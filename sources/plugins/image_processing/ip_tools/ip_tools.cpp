...
#include <image_blocks_16x16.h>
#include "imodule.h"

// Descriptor of the module
ModuleDescriptor moduleInfo =
{
    { 0xAF000001, 0x00000000, 0x00000000, 0x00000007 },
    { 1, 0, 3 },
    "Image Processing Tools",
    "ip_tools",
    "The module contains different image processing tools.",
    "Computer Vision Sandbox",
    "Copyright Computer Vision Sandbox, 2011-2018",
    "http://www.cvsandbox.com/",
    (ximage*) &image_blocks_16x16, // small icon
    0, // icon
    0
};
