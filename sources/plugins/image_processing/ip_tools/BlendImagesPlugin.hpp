...
#pragma once
#ifndef CVS_BLEND_IMAGES_PLUGIN_HPP
#define CVS_BLEND_IMAGES_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class BlendImagesPlugin : public IImageProcessingFilterPlugin2
{
public:
    BlendImagesPlugin( );
...
#endif // CVS_BLEND_IMAGES_PLUGIN_HPP
