...
#pragma once
#ifndef CVS_UNIFORM_ADDITIVE_NOISE_PLUGIN_HPP
#define CVS_UNIFORM_ADDITIVE_NOISE_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class UniformAdditiveNoisePlugin : public IImageProcessingFilterPlugin
{
public:
...
#endif // CVS_UNIFORM_ADDITIVE_NOISE_PLUGIN_HPP