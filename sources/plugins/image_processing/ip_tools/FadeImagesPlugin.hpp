...
#pragma once
#ifndef CVS_FADE_IMAGES_PLUGIN_HPP
#define CVS_FADE_IMAGES_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class FadeImagesPlugin : public IImageProcessingFilterPlugin2
{
public:
    FadeImagesPlugin( );
...
private:
    ...
    float firstImageAmountToKeep;
};

#endif // CVS_FADE_IMAGES_PLUGIN_HPP
