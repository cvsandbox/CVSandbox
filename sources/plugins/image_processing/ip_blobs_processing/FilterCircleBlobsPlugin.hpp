...
#pragma once
#ifndef CVS_FILTER_CIRCLE_BLOBS_PLUGIN_HPP
#define CVS_FILTER_CIRCLE_BLOBS_PLUGIN_HPP
...
class FilterCircleBlobsPlugin : public IImageProcessingFilterPlugin
{
public:
...
private:
    ...
    Private::FilterCircleBlobsPluginData* mData;
};

#endif // CVS_FILTER_CIRCLE_BLOBS_PLUGIN_HPP
