...
#pragma once
#ifndef CVS_FILTER_QUADRILATERAL_BLOBS_PLUGIN_HPP
#define CVS_FILTER_QUADRILATERAL_BLOBS_PLUGIN_HPP
...
class FilterQuadrilateralBlobsPlugin : public IImageProcessingFilterPlugin
{
public:
...
private:
    ...
    Private::FilterQuadrilateralBlobsPluginData* mData;
};

#endif // CVS_FILTER_QUADRILATERAL_BLOBS_PLUGIN_HPP
