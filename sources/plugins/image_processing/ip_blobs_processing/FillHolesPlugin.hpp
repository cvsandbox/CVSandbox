...
#pragma once
#ifndef CVS_FILL_HOLES_PLUGIN_HPP
#define CVS_FILL_HOLES_PLUGIN_HPP
...
class FillHolesPlugin : public IImageProcessingFilterPlugin
{
public:
    FillHolesPlugin( );
...
private:
    ...
    Private::FillHolesPluginData*     mData;
};

#endif // CVS_FILL_HOLES_PLUGIN_HPP
