...
#pragma once
#ifndef CVS_KEEP_BIGGEST_BLOB_PLUGIN_HPP
#define CVS_KEEP_BIGGEST_BLOB_PLUGIN_HPP
...
class KeepBiggestBlobPlugin : public IImageProcessingFilterPlugin
{
public:
...
private:
    ...
    Private::KeepBiggestBlobPluginData* mData;
};

#endif // CVS_KEEP_BIGGEST_BLOB_PLUGIN_HPP
