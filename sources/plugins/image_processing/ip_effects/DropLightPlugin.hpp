...
#pragma once
#ifndef CVS_DROP_LIGHT_PLUGIN_HPP
#define CVS_DROP_LIGHT_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class DropLightPlugin : public IImageProcessingFilterPlugin
{
public:
    DropLightPlugin( );
...
#endif // CVS_DROP_LIGHT_PLUGIN_HPP
