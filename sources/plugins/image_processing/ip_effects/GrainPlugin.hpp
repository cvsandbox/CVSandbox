...
#pragma once
#ifndef CVS_GRAIN_PLUGIN_HPP
#define CVS_GRAIN_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class GrainPlugin : public IImageProcessingFilterPlugin
{
private:
    ~GrainPlugin( );
...
private:
    ...
    bool        staticSeed;
    ximage*     textureImage;
    uint16_t    oldGrainSeed;
    bool        regenerateTexture;
};

#endif // CVS_GRAIN_PLUGIN_HPP
