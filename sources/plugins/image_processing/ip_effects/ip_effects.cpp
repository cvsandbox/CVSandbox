...
#include <image_effects_module_16x16.h>
#include "imodule.h"

// Descriptor of the module
ModuleDescriptor moduleInfo =
{
    { 0xAF000001, 0x00000000, 0x00000000, 0x00000006 },
    { 1, 0, 1 },
    "Image Processing Effects",
    "ip_effects",
    "The module contains set of artistic effects used in image processing.",
    "Computer Vision Sandbox",
    "Copyright Computer Vision Sandbox, 2011-2018",
    "http://www.cvsandbox.com/",
    (ximage*) &image_effects_module_16x16, // small icon
    0, // icon
    0
};
