...
#pragma once
#ifndef CVS_APPLY_TEXTURE_PLUGIN_HPP
#define CVS_APPLY_TEXTURE_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class ApplyTexturePlugin : public IImageProcessingFilterPlugin2
{
public:
    ApplyTexturePlugin( );
...
private:
    ...
    float       amountToKeep;
    uint8_t     textureBaseLevel;
};

#endif // CVS_APPLY_TEXTURE_PLUGIN_HPP
