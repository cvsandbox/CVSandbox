...
#pragma once
#ifndef CVS_ROUNDED_BORDER_PLUGIN_HPP
#define CVS_ROUNDED_BORDER_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class RoundedBorderPlugin : public IImageProcessingFilterPlugin
{
private:
    ~RoundedBorderPlugin( );
...
#endif // CVS_ROUNDED_BORDER_PLUGIN_HPP
