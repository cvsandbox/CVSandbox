...
#pragma once
#ifndef CVS_ROTATE_HUE_PLUGIN_HPP
#define CVS_ROTATE_HUE_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class RotateHuePlugin : public IImageProcessingFilterPlugin
{
public:
    RotateHuePlugin( );
...
#endif // CVS_ROTATE_HUE_PLUGIN_HPP
