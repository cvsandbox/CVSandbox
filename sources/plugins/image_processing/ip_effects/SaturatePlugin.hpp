...
#pragma once
#ifndef CVS_SATURATE_PLUGIN_HPP
#define CVS_SATURATE_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class SaturatePlugin : public IImageProcessingFilterPlugin
{
public:
    SaturatePlugin( );
...
private:
    ...
    int8_t                            saturateValue;
};

#endif // CVS_SATURATE_PLUGIN_HPP
