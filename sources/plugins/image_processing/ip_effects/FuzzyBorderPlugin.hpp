...
#pragma once
#ifndef CVS_FUZZY_BORDER_PLUGIN_HPP
#define CVS_FUZZY_BORDER_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class FuzzyBorderPlugin : public IImageProcessingFilterPlugin
{
private:
    ~FuzzyBorderPlugin( );
...
#endif // CVS_FUZZY_BORDER_PLUGIN_HPP
