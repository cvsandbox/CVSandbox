...
#pragma once
#ifndef CVS_OIL_PAINTING_PLUGIN_HPP
#define CVS_OIL_PAINTING_PLUGIN_HPP

#include <ximaging.h>
#include <iplugintypescpp.hpp>

class OilPaintingPlugin : public IImageProcessingFilterPlugin
{
public:
    OilPaintingPlugin( );
...
#endif // CVS_OIL_PAINTING_PLUGIN_HPP
