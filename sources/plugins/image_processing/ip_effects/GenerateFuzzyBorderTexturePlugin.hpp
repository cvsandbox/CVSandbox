...
#pragma once
#ifndef CVS_GENERATE_FUZZY_BORDER_TEXTURE_PLUGIN_HPP
#define CVS_GENERATE_FUZZY_BORDER_TEXTURE_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class GenerateFuzzyBorderTexturePlugin : public IImageGenerationPlugin
{
public:
...
private:
    ...
    uint16_t    gradientWidth;
    uint16_t    waviness;
    uint16_t    randValue;
};

#endif // CVS_GENERATE_FUZZY_BORDER_TEXTURE_PLUGIN_HPP
