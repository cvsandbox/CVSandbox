...
#pragma once
#ifndef CVS_ROTATE_RGB_CHANNELS_PLUGIN_HPP
#define CVS_ROTATE_RGB_CHANNELS_PLUGIN_HPP

#include <iplugintypescpp.hpp>

class RotateRgbChannelsPlugin : public IImageProcessingFilterPlugin
{
public:
...
#endif // CVS_ROTATE_RGB_CHANNELS_PLUGIN_HPP
