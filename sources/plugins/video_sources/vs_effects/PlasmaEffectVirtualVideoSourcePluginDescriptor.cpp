...
// ID of the plug-in
static xguid PluginID = { 0xAF000003, 0x00000000, 0x00000009, 0x00000003 };
...
const PropertyDescriptor** PlasmaEffectVirtualVideoSourcePlugin::propertiesDescription = (const PropertyDescriptor**) pluginProperties;
...
(
    ...
    PluginVersion,
    "Plasma Effect Virtual Video Source",
    "PlasmaEffectVirtualVideoSource",
    "Plug-in providing virtual video source with plasma effect.",
    "Some help about this routine.",
    0, //&image_jpeg_stream_16x16,
    0,
    PlasmaEffectVirtualVideoSourcePlugin,
