...
// ID of the plug-in
static xguid PluginID = { 0xAF000003, 0x00000000, 0x00000009, 0x00000002 };
...
const PropertyDescriptor** ColorSnakeVirtualVideoSourcePlugin::propertiesDescription = (const PropertyDescriptor**) pluginProperties;
...
(
    ...
    PluginVersion,
    "Color Snake Virtual Video Source",
    "ColorSnakeVirtualVideoSource",
    "Plug-in providing virtual video source with a \"color snake\".",
