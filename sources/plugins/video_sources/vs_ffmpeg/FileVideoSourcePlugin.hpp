...
#pragma once
#ifndef CVS_FILE_VIDEO_SOURCE_PLUGIN_HPP
#define CVS_FILE_VIDEO_SOURCE_PLUGIN_HPP
...
class FileVideoSourcePlugin : public IVideoSourcePlugin
{
public:
...
private:
    ::Private::FileVideoSourcePluginData* mData;
    static const PropertyDescriptor**     propertiesDescription;
};

#endif // CVS_FILE_VIDEO_SOURCE_PLUGIN_HPP
