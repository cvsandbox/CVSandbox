...
#pragma once
#ifndef CVS_NETWORK_STREAM_VIDEO_SOURCE_PLUGIN_HPP
#define CVS_NETWORK_STREAM_VIDEO_SOURCE_PLUGIN_HPP
...
namespace Private
{
    class NetworkStreamVideoSourcePluginData;
}

class NetworkStreamVideoSourcePlugin : public IVideoSourcePlugin
{
public:
...
private:
    ::Private::NetworkStreamVideoSourcePluginData* mData;
};

#endif // CVS_NETWORK_STREAM_VIDEO_SOURCE_PLUGIN_HPP
