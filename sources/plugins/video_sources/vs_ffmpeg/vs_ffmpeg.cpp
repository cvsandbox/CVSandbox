...
#include <imodule.h>
#include <image_ffmpeg_16x16.h>

// Descriptor of the module
ModuleDescriptor moduleInfo =
{
    { 0xAF000001, 0x00000000, 0x00000000, 0x0000000B },
    { 1, 0, 2 },
    "FFmpeg Based Video Sources",
    "vs_ffmpeg",
    "The module contains different video source plug-ins based on FFmpeg library.",
    "Computer Vision Sandbox",
    "Copyright Computer Vision Sandbox, 2011-2019",
    "http://www.cvsandbox.com/",
    (ximage*) &image_ffmpeg_16x16, // small icon
    0, // icon
    0
};
