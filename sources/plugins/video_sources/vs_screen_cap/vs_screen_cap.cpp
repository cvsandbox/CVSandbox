...
{
    { 0xAF000001, 0x00000000, 0x00000000, 0x00000012 },
    { 1, 0, 0 },
    "Screen Capture Plug-ins",
    "vs_screen_capture",
    "The module contains plug-in to capture system's screen content.",
    "Computer Vision Sandbox",
    "Copyright Computer Vision Sandbox, 2011-2016",
    "http://www.cvsandbox.com/",
    (ximage*) &image_screen_16x16, // small icon
    nullptr, // icon
    0
};
