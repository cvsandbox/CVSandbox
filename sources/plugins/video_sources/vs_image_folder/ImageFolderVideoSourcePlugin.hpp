...
#pragma once
#ifndef CVS_IMAGE_FOLDER_VIDEO_SOURCE_PLUGIN_HPP
#define CVS_IMAGE_FOLDER_VIDEO_SOURCE_PLUGIN_HPP
...
class ImageFolderVideoSourcePlugin : public IVideoSourcePlugin
{
public:
...
private:
    ::Private::ImageFolderVideoSourcePluginData* mData;
    static const PropertyDescriptor**            propertiesDescription;
};

#endif // CVS_IMAGE_FOLDER_VIDEO_SOURCE_PLUGIN_HPP
