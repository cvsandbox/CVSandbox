...
#pragma once
#ifndef CVS_VIDEO_REPEATER_PLUGIN_HPP
#define CVS_VIDEO_REPEATER_PLUGIN_HPP
...
class VideoRepeaterPlugin : public IVideoSourcePlugin
{
public:
    VideoRepeaterPlugin( );
    virtual ~VideoRepeaterPlugin( );
...
public:
    ...
    void PushImage( const ximage* image );

private:
    ::Private::VideoRepeaterPluginData* mData;
    static const PropertyDescriptor**   propertiesDescription;
};

#endif // CVS_VIDEO_REPEATER_PLUGIN_HPP
