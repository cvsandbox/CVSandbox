...
{
    { 0xAF000001, 0x00000000, 0x00000000, 0x00000010 },
    { 1, 0, 0 },
    "Video Repeater Plug-ins",
    "vs_repeater",
    "The module contains video repeater's plug-ins.",
    "Computer Vision Sandbox",
    "Copyright Computer Vision Sandbox, 2011-2019",
    "http://www.cvsandbox.com/",
    (ximage*) &image_video_repeater_plugin_16x16, // small icon
    0, // icon
    0
};
