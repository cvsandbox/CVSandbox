...
#pragma once
#ifndef CVS_VIDEO_REPEATER_PUSH_PLUGIN_HPP
#define CVS_VIDEO_REPEATER_PUSH_PLUGIN_HPP
...
namespace Private
{
    class VideoRepeaterPushPluginData;
}

class VideoRepeaterPushPlugin : public IVideoProcessingPlugin
{
public:
