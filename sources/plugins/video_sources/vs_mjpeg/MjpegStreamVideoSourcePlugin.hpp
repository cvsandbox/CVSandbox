...
#pragma once
#ifndef CVS_MJPEG_STREAM_VIDEO_SOURCE_PLUGIN_HPP
#define CVS_MJPEG_STREAM_VIDEO_SOURCE_PLUGIN_HPP
...
namespace Private
{
    class MjpegStreamVideoSourcePluginData;
}

class MjpegStreamVideoSourcePlugin : public IVideoSourcePlugin
{
public:
...
private:
    ::Private::MjpegStreamVideoSourcePluginData* mData;
};

#endif // CVS_MJPEG_STREAM_VIDEO_SOURCE_PLUGIN_HPP
