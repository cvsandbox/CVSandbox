...
#pragma once
#ifndef CVS_JPEG_STREAM_VIDEO_SOURCE_PLUGIN_HPP
#define CVS_JPEG_STREAM_VIDEO_SOURCE_PLUGIN_HPP
...
namespace Private
{
    class JpegStreamVideoSourcePluginData;
}

class JpegStreamVideoSourcePlugin : public IVideoSourcePlugin
{
public:
...
private:
    ::Private::JpegStreamVideoSourcePluginData* mData;
};

#endif // CVS_JPEG_STREAM_VIDEO_SOURCE_PLUGIN_HPP
