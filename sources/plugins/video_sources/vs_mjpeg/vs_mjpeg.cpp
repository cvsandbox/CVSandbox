...
#include <imodule.h>
#include <image_jpeg_image_16x16.h>

// Descriptor of the module
ModuleDescriptor moduleInfo =
{
    { 0xAF000001, 0x00000000, 0x00000000, 0x00000005 },
    { 1, 0, 3 },
    "JPEG/MJPEG Video Sources",
    "vs_mjpeg",
    "The module contains plug-ins to access JPEG/MJPEG streams over HTTP protocol as well as local JPEG folders.",
    "Computer Vision Sandbox",
    "Copyright Computer Vision Sandbox, 2011-2019",
    "http://www.cvsandbox.com/",
    (ximage*) &image_jpeg_image_16x16, // small icon
    nullptr, // icon
    0
};
