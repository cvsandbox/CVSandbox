...
#pragma once
#ifndef CVS_GLYPH_DETECTOR_PLUGIN_HPP
#define CVS_GLYPH_DETECTOR_PLUGIN_HPP
...
class GlyphDetectorPlugin : public IImageProcessingPlugin
{
public:
    GlyphDetectorPlugin( );
    ~GlyphDetectorPlugin( );
...
private:
    ...
    Private::GlyphDetectorPluginData* mData;
};

#endif // CVS_GLYPH_DETECTOR_PLUGIN_HPP
