...
#pragma once
#ifndef CVS_WRAPPER_IMAGE_PROCESSING_HPP
#define CVS_WRAPPER_IMAGE_PROCESSING_HPP

#include "iplugintypescpp.hpp"
#include "WrapperBaseForCppPlugin.hpp"

// An internal class to register C++ Image Processing plug-in and wrap it into C structure
class PluginRegister_PluginType_ImageProcessing : public PluginRegisterAndWrapper
{
private:
    // Extended structure containing pointer to C++ object
    typedef struct _CppImageProcessingWrapper
    {
        SImageProcessingPlugin  Api;
        IImageProcessingPlugin* PluginObject;
    }
    CppImageProcessingWrapper;

    // Wrapper for Dispose() method
    static void Wrapper_Dispose( SPluginBase* me )
    {
        reinterpret_cast<CppImageProcessingWrapper*>( me )->PluginObject->Dispose();
        free( me );
    }
    ...
    {
        return reinterpret_cast<CppImageProcessingWrapper*>( me )->PluginObject->GetProperty( id, value );
    }

    // Wrapper for SetProperty() method
    static XErrorCode Wrapper_SetProperty( SPluginBase* me, int32_t id, const xvariant* value )
    {
        return reinterpret_cast<CppImageProcessingWrapper*>( me )->PluginObject->SetProperty( id, value );
    }
    ...
    {
        return reinterpret_cast<CppImageProcessingWrapper*>( me )->PluginObject->GetIndexedProperty( id, index, value );
    }
    ...
    {
        return reinterpret_cast<CppImageProcessingWrapper*>( me )->PluginObject->SetIndexedProperty( id, index, value );
    }
    ...
    {
        return reinterpret_cast<CppImageProcessingWrapper*>( me )->PluginObject->CallFunction( id, returnValue, arguments );
    }
    ...
    {
        return reinterpret_cast<CppImageProcessingWrapper*>( me )->PluginObject->UpdateDescription( descriptor );
    }

    // Wrapper for GetSupportedPixelFormats() method
    static XErrorCode Wrapper_GetSupportedPixelFormats( SImageProcessingPlugin* me, XPixelFormat* pixelFormats, int32_t* count )
    {
        return reinterpret_cast<CppImageProcessingWrapper*>( me )->PluginObject->GetSupportedPixelFormats( pixelFormats, count );
    }

    // Wrapper for ProcessImage() method
    static XErrorCode Wrapper_ProcessImage( SImageProcessingPlugin* me, const ximage* image )
    {
        return reinterpret_cast<CppImageProcessingWrapper*>( me )->PluginObject->ProcessImage( image );
    }

public:
    PluginRegister_PluginType_ImageProcessing( xguid id, xguid family,
    ...
    static SImageProcessingPlugin* CreateWrapper( IImageProcessingPlugin* po )
    {
        CppImageProcessingWrapper* wrapper = (CppImageProcessingWrapper*) malloc( sizeof( CppImageProcessingWrapper ) );
        ...
        return reinterpret_cast<SImageProcessingPlugin*>( wrapper );
    }
};

#endif // CVS_WRAPPER_IMAGE_PROCESSING_HPP
