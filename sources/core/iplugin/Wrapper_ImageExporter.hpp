...
#pragma once
#ifndef CVS_WRAPPER_IMAGE_EXPORTER_HPP
#define CVS_WRAPPER_IMAGE_EXPORTER_HPP

#include "iplugintypescpp.hpp"
#include "WrapperBaseForCppPlugin.hpp"

// An internal class to register C++ Image Exporter plug-in and wrap it into C structure
class PluginRegister_PluginType_ImageExporter : public PluginRegisterAndWrapper
{
private:
    // Extended structure containing pointer to C++ object
    typedef struct _CppImageExporterWrapper
    {
        SImageExportingPlugin  Api;
        IImageExportingPlugin* PluginObject;
    }
    CppImageExporterWrapper;

    // Wrapper for Dispose() method
    static void Wrapper_Dispose( SPluginBase* me )
    {
        reinterpret_cast<CppImageExporterWrapper*>( me )->PluginObject->Dispose();
        free( me );
    }
    ...
    {
        return reinterpret_cast<CppImageExporterWrapper*>( me )->PluginObject->GetProperty( id, value );
    }

    // Wrapper for SetProperty() method
    static XErrorCode Wrapper_SetProperty( SPluginBase* me, int32_t id, const xvariant* value )
    {
        return reinterpret_cast<CppImageExporterWrapper*>( me )->PluginObject->SetProperty( id, value );
    }
    ...
    {
        return reinterpret_cast<CppImageExporterWrapper*>( me )->PluginObject->GetIndexedProperty( id, index, value );
    }
    ...
    {
        return reinterpret_cast<CppImageExporterWrapper*>( me )->PluginObject->SetIndexedProperty( id, index, value );
    }
    ...
    {
        return reinterpret_cast<CppImageExporterWrapper*>( me )->PluginObject->CallFunction( id, returnValue, arguments );
    }
    ...
    {
        return reinterpret_cast<CppImageExporterWrapper*>( me )->PluginObject->UpdateDescription( descriptor );
    }

    // Wrapper for GetFileTypeDescription() method
    static xstring Wrapper_GetFileTypeDescription( SImageExportingPlugin* me )
    {
        return reinterpret_cast<CppImageExporterWrapper*>( me )->PluginObject->GetFileTypeDescription( );
    }

    // Wrapper for GetSupportedExtensions() method
    static XErrorCode Wrapper_GetSupportedExtensions( SImageExportingPlugin* me, xstring* fileExtensions, int32_t* count )
    {
        return reinterpret_cast<CppImageExporterWrapper*>( me )->PluginObject->GetSupportedExtensions( fileExtensions, count );
    }

    // Wrapper for GetSupportedPixelFormats() method
    static XErrorCode Wrapper_GetSupportedPixelFormats( SImageExportingPlugin* me, XPixelFormat* pixelFormats, int32_t* count )
    {
        return reinterpret_cast<CppImageExporterWrapper*>( me )->PluginObject->GetSupportedPixelFormats( pixelFormats, count );
    }

    // Wrapper for ExportImage() method
    static XErrorCode Wrapper_ExportImage( SImageExportingPlugin* me, xstring fileName, const ximage* image )
    {
        return reinterpret_cast<CppImageExporterWrapper*>( me )->PluginObject->ExportImage( fileName, image );
    }

public:
    PluginRegister_PluginType_ImageExporter( xguid id, xguid family,
        uint32_t type, xversion version,
    ...
    static SImageExportingPlugin* CreateWrapper( IImageExportingPlugin* po )
    {
        CppImageExporterWrapper* wrapper = (CppImageExporterWrapper*) malloc( sizeof( CppImageExporterWrapper ) );
        ...
        // set image exporter plug-in's methods
        ...
        wrapper->Api.ExportImage              = Wrapper_ExportImage;

        return reinterpret_cast<SImageExportingPlugin*>( wrapper );
    }
};

#endif // CVS_WRAPPER_IMAGE_EXPORTER_HPP
