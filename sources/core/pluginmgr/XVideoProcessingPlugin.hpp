...
#pragma once
#ifndef CVS_XVIDEO_PROCESSING_PLUGIN_HPP
#define CVS_XVIDEO_PROCESSING_PLUGIN_HPP

#include <vector>
#include <XImage.hpp>
#include "XPlugin.hpp"

class XVideoProcessingPlugin : public XPlugin
{
private:
    XVideoProcessingPlugin( void* plugin, bool ownIt );

public:
    virtual ~XVideoProcessingPlugin( );

    // Create plug-in wrapper
    static const std::shared_ptr<XVideoProcessingPlugin> Create( void* plugin, bool ownIt = true );
...
#endif // CVS_XVIDEO_PROCESSING_PLUGIN_HPP
