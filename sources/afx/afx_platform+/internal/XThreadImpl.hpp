...
#pragma once
#ifndef CVS_XTHREAD_IMPL_HPP
#define CVS_XTHREAD_IMPL_HPP
...
// Platform specific thread managing implementation
class XThreadImpl
{
public:
    XThreadImpl( );
    ...
    bool Create( CVSandbox::Threading::XThreadFunction callback, void* param );
...
private:
    XThreadImplData* mData;
};

} } } // namespace CVSandbox::Threading::Private

#endif // CVS_XTHREAD_IMPL_HPP
